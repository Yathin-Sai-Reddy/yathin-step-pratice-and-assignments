...
public class PalindromeChecker {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Iterative: " + formatResult(isPalindromeIterative(text))
                + " | Recursive: " + formatResult(isPalindromeRecursive(text))
                + " | Array Reversal: " + formatResult(isPalindromeArrayReversal(text)));
    }
}